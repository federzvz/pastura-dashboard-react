...
export const PostFilterSidebar = () => (
    <Card sx={{ order: -1, mr: 2, mt: 9, width: 450 }}>
        <CardContent>
            ...
            <FilterList label="Macollo 1" icon={<MailIcon />}>
            ...
            <FilterList label="Macollo 2" icon={<MailIcon />}>
            ...
            <FilterList label="Consistencia de la Ligula" icon={<MailIcon />}>
            ...
            <FilterList label="Forma de la ligula" icon={<MailIcon />}>
            ...
            <FilterList label="Forma de la lamina" icon={<MailIcon />}>
            ...
            <FilterList label="Tipo de lamina" icon={<MailIcon />}>
